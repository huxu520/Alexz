(function($) {
	$.fn.html5lightbox = function(k) {
		...
		l.createMarkup = function() {
			...
			l.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999999;'>" + "<div id='html5-lightbox-overlay' style='visibility:visible;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:" + l.options.overlaybgcolor + ";opacity:" + l.options.overlayopacity + ";filter:alpha(opacity=" + Math.round(l.options.overlayopacity * 100) + ");'></div>" + "<div id='html5-lightbox-box' style='visibility:visible;position:relative;margin:0px auto;overflow:hidden;'>" + "<div id='html5-elem-box' style='visibility:visible;position:relative;margin:0px auto;text-align:center;'>" + "<div id='html5-elem-wrap' style='visibility:visible;position:relative;margin:0px auto;text-align:center;background-color:" + l.options.bgcolor + ";'>" + "<div id='html5-loading' style='display:none;position:absolute;top:0px;left:0px;text-align:center;width:100%;height:100%;background:url(\"" + l.options.skinfolder + l.options.loadingimage + "\") no-repeat center center;'></div>" + "<div id='html5-error' class='html5-error' style='display:none;position:absolute;padding:" + l.options.bordersize + "px;text-align:center;width:" + l.options.errorwidth + "px;height:" + l.options.errorheight + "px;'>" + "The requested content cannot be loaded.<br />Please try again later." + "</div>" + "<div id='html5-image' style='display:none;position:absolute;top:0px;left:0px;padding:" + l.options.bordersize + "px;text-align:center;'></div>" + "</div>" + "<div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + l.options.bordersize + "px;top:40%;'><img src='" + l.options.skinfolder + l.options.nextimage + "'></div>" + "<div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + l.options.bordersize + "px;top:40%;'><img src='" + l.options.skinfolder + l.options.previmage + "'></div>" + "</div>" + "<div id='html5-elem-data-box' style='display:none;position:relative;width:100%;margin:0px auto;height:" + l.options.barheight + "px;background-color:" + l.options.bgcolor + ";'>" + "<div id='html5-text' style='visibility:visible;float:left;overflow:hidden;margin-left:" + l.options.bordersize + "px;'></div>" + "<div id='html5-close' style='visibility:visible;cursor:pointer;float:right;margin-right:" + l.options.bordersize + "px;'><img src='" + l.options.skinfolder + l.options.closeimage + "'></div>" + "</div>" + "<div id='html5-watermark' style='display:none;position:absolute;left:" + String(l.options.bordersize + 2) + "px;top:" + String(l.options.bordersize + 2) + "px;'></div>" + "</div>" + "</div>");
			l.$lightbox.css({
			...
			if(l.options.stamp) {
				l.$watermark.html("<a href='" + l.options.freelink + "' style='text-decoration:none;'><div style='visibility:visible;width:120px;height:20px;text-align:center;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;filter:alpha(opacity=60);opacity:0.6;background-color:#333333;color:#ffffff;font:12px Armata,sans-serif,Arial;'><div style='line-height:20px;'>" + l.options.freemark + "</div></div></a>")
		...
		l.showSWF = function(a) {
			...
			l.resizeLightbox(b, c, true, function() {
				...
				l.$text.html(a[ELEM_TITLE]);
				l.$image.html("<div id='html5lightbox-swf' style='visibility:visible;width:" + b + "px;height:" + c + "px;'></div>").show();
		...
		l.showVideo = function(d) {
			...
			l.resizeLightbox(e, f, true, function() {
				...
				l.$image.html("<div id='html5lightbox-video' style='visibility:visible;width:" + e + "px;height:" + f + "px;'></div>").show();
				var a = false;
				if(l.options.isMobile) {
					a = true
		...
		l.showyoukuVimeo = function(b) {
			...
			l.resizeLightbox(c, d, true, function() {
				...
				l.$image.html("<div id='html5lightbox-video' style='visibility:visible;width:" + c + "px;height:" + d + "px;'></div>").show();
				var a = b[ELEM_HREF];
		...
		l.showWeb = function(a) {
			...
			l.resizeLightbox(b, c, true, function() {
				...
				l.$text.html(a[ELEM_TITLE]);
				l.$image.html("<div id='html5lightbox-web' style='visibility:visible;width:" + b + "px;height:" + c + "px;'></div>").show();
		...
		l.embedHTML5Video = function(a, w, h, b, c) {
			a.html("<div style='position:absolute;visibility:visible;width:" + w + "px;height:" + h + "px;'><video width=" + w + " height=" + h + ((c) ? " autoplay" : "") + " controls='controls' src='" + b + "'></div>");
			if(l.options.isAndroid) {
				var d = $("<div style='position:absolute;visibility:visible;cursor:pointer;width:" + w + "px;height:" + h + "px;background:url(\"" + l.options.skinfolder + l.options.playvideoimage + "\") no-repeat center center;'></div>").appendTo(a);
		...
		l.embedFlash = function(a, w, h, b, c, d) {
			if(l.options.flashInstalled) {
				...
				a.html("<div class='html5lightbox-flash-error' style='visibility:visible; position:relative;text-align:center; width:" + w + "px; left:0px; top:" + Math.round(h / 2 - 10) + "px;'><div class='html5-error'><div>The required Adobe Flash Player plugin is not installed</div><br /><div style='visibility:visible;position:relative;text-align:center;width:112px;height:33px;margin:0px auto;'><a href='http://www.adobe.com/go/getflashplayer'><img src='http://www.adobe.com/images/shared/download_buttons/get_flash_player.gif' alt='Get Adobe Flash player' width='112' height='33'></img></a></div></div>")
			}
		};
	...
	$.fn.html5zoo = function(G) {
		...
		J.prototype = {
			...
			playyoukuVideo: function(b, c) {
				...
				if(ASyoukuIframeAPIReady && !ASPlatforms.isIE6() && !ASPlatforms.isIE7() && !ASPlatforms.isIOS()) {
					d.html("<div id='html5zoo-video-" + this.id + "' style='visibility:visible;'></div>");
			...
			createStyle: function() {
				...
				var a = ".html5zoo-wrapper-" + this.id + " {visibility:visible;position:relative;width:100%;height:auto;}";
				a += ".html5zoo-slider-" + this.id + " {visibility:visible;position:relative;left:0px;top:0px;width:100%;height:auto;";
				...
				a += "}";
				a += ".html5zoo-box-" + this.id + " {visibility:visible;position:relative;left:0px;top:0px;width:100%;height:auto;}";
				a += ".html5zoo-swipe-box-" + this.id + " {visibility:visible;position:relative;left:0px;top:0px;width:100%;height:auto;}";
				a += ".html5zoo-space-" + this.id + " {visibility:visible;position:relative;left:0px;top:0px;width:100%;height:auto;visibility:hidden;line-height:0px;font-size:0px;}";
				a += ".html5zoo-img-box-" + this.id + " {visibility:visible;position:absolute;left:0px;top:0px;width:100%;height:100%;}";
				...
				a += ".html5zoo-error-" + this.id + " {visibility:visible;position:relative;margin:0 auto;width:80%;top:50%;color:#fff;font:16px Arial,Tahoma,Helvetica,sans-serif;}";
				...
				if(this.options.showribbon) {
					a += ".html5zoo-ribbon-" + this.id + " {visibility:visible;position:absolute;";
			...
			createBottomShadow: function() {
				...
				a.html("<img src='" + this.options.skinsfolder + this.options.bottomshadowimage + "' style='visibility:visible;position:relative;width:100%;height:auto;' />")
			},
			createBackgroundImage: function() {
				...
				a.html("<img src='" + this.options.skinsfolder + this.options.backgroundimage + "' style='visibility:visible;position:relative;width:100%;height:auto;' />")
			},
			...
			createNav: function() {
				...
				var j = $("<div class='html5zoo-bullet-wrapper-" + this.id + "' style='visibility:visible;position:relative;'></div>");
				...
				if(this.options.navstyle != 'none') {
					...
					if(this.options.navshowpreview) {
						...
						var y = $("<div class='html5zoo-nav-preview-arrow-" + this.id + "' style='visibility:visible;position:absolute;width:" + this.options.navpreviewarrowwidth + "px;height:" + this.options.navpreviewarrowheight + "px;" + "background:url(\"" + this.options.skinsfolder + this.options.navpreviewarrowimage + "\") no-repeat center center;' ></div>");
						...
						var z = $("<div class='html5zoo-nav-preview-images-" + this.id + "' style='visibility:visible;position:relative;width:100%;height:100%;overflow:hidden;' />");
						x.append(y);
						x.append(z);
			...
			createNavBullet: function(r) {
				...
				x.hover(function() {
					...
					if(s.options.navshowpreview) {
						...
						$(q).load(function() {
							...
							if(s.options.navdirection == 'vertical') {
								var c = $("<div class='html5zoo-nav-preview-img-" + s.id + "' style='visibility:visible;position:absolute;overflow:hidden;width:" + s.options.navpreviewwidth + "px;height:" + s.options.navpreviewheight + "px;left:0px;top:" + s.options.navpreviewheight + "px;'><img src='" + s.elemArray[d][ELEM_THUMBNAIL] + "' style='visibility:visible;position:absolute;left:0px;top:0px;" + a + "' /></div>");
								f.append(c);
								if(b.length > 0) {
									b.animate({
				...
				if(this.options.navstyle == 'bullets') {
					...
					$(y).load(function() {
						...
						x.append("<div style='visibility:visible;position:absolute;width:" + s.options.navimagewidth + "px;height:" + s.options.navimageheight + "px;overflow:hidden;'><img src='" + s.elemArray[r][ELEM_THUMBNAIL] + "' style='" + a + "' /></div>");
						if((s.options.navshowplayvideo) && (s.elemArray[r][ELEM_VIDEO].length > 0)) {
							x.append("<div style='visibility:visible;position:absolute;margin-left:0;margin-top:0;width:" + s.options.navimagewidth + "px;height:" + s.options.navimageheight + "px;" + "background:url(\"" + s.options.skinsfolder + s.options.navplayvideoimage + "\") no-repeat center center;" + "' ></div>")
						}
						if(s.options.navthumbstyle != 'imageonly') {
							var b = "<div style='visibility:visible;position:absolute;overflow:hidden;";
			...
			slideRun: function(a) {
				...
				if(this.isAnimating) {
					...
					$(".html5zoo-img-box-" + this.id, this.container).unbind('transitionFinished').html("<div class='html5zoo-img-" + this.id + " ' style='visibility:visible;position:absolute;left:0px;top:0px;width:100%;height:auto;'><img style='position:absolute;max-width:100%;height:auto;left:0%;top:0%;' src='" + this.elemArray[savedCur][ELEM_SRC] + "' /></div>");
			...
			showImage: function(g) {
				...
				$(i).load(function() {
					...
					var e = $("<div class='html5zoo-img-" + h.id + " ' style='visibility:visible;position:absolute;left:0px;top:0px;width:100%;height:auto;'><img style='position:absolute;" + (ASPlatforms.isIE678() ? "opacity:inherit;filter:inherit;" : "") + "max-width:" + b + "%;height:auto;left:" + (100 - b) / 2 + "%;top:0%;' src='" + h.elemArray[h.curElem][ELEM_SRC] + "' /></div>");
		...
		this.each(function() {
			...
			var j = {
				...
				addgooglefonts: true,
				googlefonts: "Inder",
				textcss: 'visibility:visible; padding:12px; text-align:left;',
				textbgcss: 'visibility:visible; position:absolute; top:0px; left:0px; width:100%; height:100%; background-color:#333333; opacity:0.6; filter:alpha(opacity=60);',
				titlecss: 'visibility:visible; position:relative; font:bold 14px Inder,Arial,Tahoma,Helvetica,sans-serif; color:#fff;',
				descriptioncss: 'visibility:visible; position:relative; font:12px Anaheim,Arial,Tahoma,Helvetica,sans-serif; color:#fff;',
				shownumbering: false,
				...
				navthumbtitlecss: 'visibility:visible;position:relative;padding:2px 4px;text-align:left;font:bold 14px Arial,Helvetica,sans-serif;color:#333;',
				navthumbtitlehovercss: 'text-decoration:underline;',
				navthumbdescriptioncss: 'visibility:visible;position:relative;padding:2px 4px;text-align:left;font:normal 12px Arial,Helvetica,sans-serif;color:#333;',
				...
				watermarkpositioncssdefault: 'visibility:visible;position:absolute;bottom:6px;right:6px;',
...
(function($) {
	...
	$.fn.sliceTransition = function(b, c, d, e, f, g) {
		...
		for(i = 0; i < e.slicecount; i++) {
			var k = $("<div class='html5zoo-img-slice-" + b + " ' style='visibility:visible;position:absolute;left:" + i * j + "px;top:0%;width:" + j + "px;height:100%;overflow:hidden;'></div>");
	...
	$.fn.blindsTransition = function(c, d, e, f, g, h) {
		...
		for(i = 0; i < f.slicecount; i++) {
			var l = $("<div class='html5zoo-img-slice-wrapper-" + c + " ' style='visibility:visible;position:absolute;left:" + i * k + "px;top:0%;width:" + k + "px;height:100%;overflow:hidden;'></div>");
			var m = $("<div class='html5zoo-img-slice-" + c + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>");
	...
	$.fn.threedTransition = function(d, e, f, g, j, k) {
		...
		var n = $("<div class='html5zoo-img-cube-wrapper-" + d + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:100%;height:100%;'></div>");
		l.append(n);
		...
		for(i = 0; i < g.slicecount; i++) {
			...
			var p = $("<div class='html5zoo-img-slice-" + d + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;background-color:" + g.bgcolor + ";'></div>");
			p.append(o);
			...
			var r = $("<div class='html5zoo-img-slice-" + d + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;background-color:" + g.bgcolor + ";'></div>");
			r.append(q);
			var s = $("<div class='html5zoo-img-slice-left-" + d + " ' style='visibility:visible;position:absolute;left:2px;top:2px;width:" + (h - 1) + "px;height:" + (h - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + g.bgcolor + ";'></div>");
			var t = $("<div class='html5zoo-img-slice-right-" + d + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:" + (h - 1) + "px;height:" + (h - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + g.bgcolor + ";'></div>");
			var u = $("<div class='html5zoo-img-cube-" + d + " ' style='visibility:visible;position:absolute;left:" + i * m + "px;top:0%;width:" + m + "px;height:100%;'></div>");
			u.append(s);
			u.append(t);
			u.append(p);
			u.append(r);
	...
	$.fn.threedHorizontalTransition = function(d, e, f, g, j, k) {
		...
		for(i = 0; i < g.slicecount; i++) {
			...
			var r = $("<div class='html5zoo-img-slice-" + d + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;outline:1px solid transparent;background-color:" + g.bgcolor + ";'></div>");
			r.append(q);
			var s = $("<div class='html5zoo-img-slice-left-" + d + " ' style='visibility:visible;position:absolute;left:2px;top:2px;width:" + (w - 1) + "px;height:" + (w - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + g.bgcolor + ";'></div>");
			var t = $("<div class='html5zoo-img-slice-right-" + d + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:" + (w - 1) + "px;height:" + (w - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + g.bgcolor + ";'></div>");
			var u = $("<div class='html5zoo-img-cube-" + d + " ' style='visibility:visible;position:absolute;left:0%;top:" + i * m + "px;width:100%;height:" + m + "px;'></div>");
			u.append(s);
			u.append(t);
			u.append(p);
			u.append(r);
	...
	$.fn.blocksTransition = function(c, d, e, f, g, k) {
		...
		for(i = 0; i < f.rowcount; i++) {
			for(j = 0; j < f.columncount; j++) {
				var q = $("<div class='html5zoo-img-block-wrapper-" + c + " ' style='visibility:visible;position:absolute;left:" + j * m + "px;top:" + i * n + "px;width:" + m + "px;height:" + n + "px;overflow:hidden;'></div>");
				var r = $("<div class='html5zoo-img-block-" + c + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>");
	...
	$.fn.shuffleTransition = function(f, g, k, l, m, n) {
		...
		for(i = 0; i < l.rowcount; i++) {
			for(j = 0; j < l.columncount; j++) {
				var r = $("<div class='html5zoo-img-block-wrapper-next-" + f + " ' style='visibility:visible;position:absolute;left:" + j * p + "px;top:" + i * q + "px;width:" + p + "px;height:" + q + "px;overflow:hidden;'></div>");
				var s = $("<div class='html5zoo-img-block-next-" + f + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>");
				...
				r.append(s);
				o.append(r);
				var u = $("<div class='html5zoo-img-block-wrapper-prev-" + f + " ' style='visibility:visible;position:absolute;left:" + j * p + "px;top:" + i * q + "px;width:" + p + "px;height:" + q + "px;overflow:hidden;'></div>");
				var v = $("<div class='html5zoo-img-block-prev-" + f + " ' style='visibility:visible;position:absolute;left:0%;top:0%;width:100%;height:100%;overflow:hidden;'></div>");
